...
app.use((error, req, res, next) => { // при створенні middleware з чотирьма параметрами, експрес розпіняє його як спецальну функцію - error handler
    if (res.headerSent) { // res.headerSent - перевіряє, чи відправили ми вже якись response на запит
